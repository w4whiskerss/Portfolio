  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 py-5 text-white sm:px-10 lg:px-16">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col justify-center gap-6">
        ...
        <section
          id="contact"
          className="glass-surface glass-panel animate-pop-up-delay-5 relative z-20 rounded-[2.2rem] border border-white/15 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10"
        >
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-base leading-7 text-white/72 sm:text-lg">
                If you want to talk about web work, Minecraft projects,
                collabs, or just reach out, these are the best places to find me.
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="glass-chip group rounded-[1.6rem] border border-white/12 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-white/20"
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/62">
                  Projects, code, and public updates.
                </p>
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/62">
                  Best place for direct contact and quick replies.
                </p>
                <span className="mt-4 inline-flex text-sm font-medium text-orange-200 transition-colors duration-300 group-hover:text-orange-100">
                  Join Server
                </span>
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/62">
                  Reach out through the community around my main server project.
                </p>
                <span className="mt-4 inline-flex text-sm font-medium text-orange-200 transition-colors duration-300 group-hover:text-orange-100">
                  Open Server
                </span>
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/62">
                  Follow the creator side of the portfolio and future updates.
                </p>
                <span className="mt-4 inline-flex text-sm font-medium text-orange-200 transition-colors duration-300 group-hover:text-orange-100">
                  Visit Channel
                </span>
